...
useful when you need to add, delete, or modify elements. A tuple is ordered but
immutable, making it ideal for fixed records such as coordinates or constant data sets.
A dictionary stores key-value pairs, allowing for fast lookups using a descriptive key.
Each problem includes input/output design, validation rules, and test cases, 
demonstrating practical applications such as shopping lists, product catalogs, 
rating management, word frequencies, and a simple contact list. The document highlights how 
collections help to efficiently organize, process, and retrieve data in real-world programs.
------------------------------------------------------------
------------------------------------------------------------
...
"""
Problem 3: Product catalog whith dictionary
------------------------------------------------------------
Description:
...
Las listas son ideales cuando los datos deben modificarse con frecuencia, ya que 
permiten añadir, eliminar y actualizar elementos con flexibilidad. Las tuplas son 
útiles para almacenar datos fijos que no deben cambiar, como coordenadas o valores de configuración.
Los diccionarios facilitan las búsquedas porque se accede a cada valor mediante una clave 
específica, lo que evita tener que explorar toda la estructura. Al combinarlos, surgen patrones
comunes, como el uso de diccionarios que almacenan listas, lo que permite agrupar la información 
con una búsqueda rápida por clave.
------------------------------------------------------------
Referencias
------------------------------------------------------------
