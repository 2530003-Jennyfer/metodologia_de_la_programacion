...
# Nombre: Jennyfer Rodriguez Ruiz
# Matrícula: 2530003
# Grupo: IM 1-3
# ------------------------------
...
#--------------------------------------------------
# # El for es útil cuando sabemos cuántas veces repetir, 
# mientras que while sirve para repetir según una condición.
# Los contadores y acumuladores permiten llevar control de sumas, 
# intentos o valores dentro de los bucles.
# Un riesgo del while es caer en ciclos infinitos si no se actualiza correctamente la condición.
# Los menús y sistemas de contraseña son ejemplos típicos donde while funciona muy bien.
# Los bucles anidados permiten crear patrones como triángulos de asteriscos 
# y entender mejor la repetición dentro de otra repetición.
